...
def derivative(nx, nz, dx, dz, order):
    """
    Compute spatial derivative operators for regular grids
    ...
    ----------
        ...
        nz : number of nodes along z
        dx : grid size along x
        dz : grid size along x
        order : 1 or 2

    Returns
    -------
        Dx : operator matrix along x
        Dz : operator matrix along z
    """
